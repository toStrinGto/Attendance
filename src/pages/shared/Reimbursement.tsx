                ...
                <div key={approval.id} className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
                  ...
                  <div className="flex space-x-3">
                    <button 
                      ...
                      className="flex-1 py-2.5 rounded-xl bg-red-50 text-red-600 font-bold text-sm flex items-center justify-center border border-red-100 active:bg-red-100"
                    >
                    ...
                    <button 
                      ...
                      className="flex-[2] py-2.5 rounded-xl bg-emerald-500 text-white font-bold text-sm flex items-center justify-center shadow-sm active:bg-emerald-600"
                    >
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="text-right flex flex-col items-end">
                      ...
                      <span className={cn("text-[10px] font-medium px-2 py-0.5 rounded-md border mt-1 inline-block", record.statusColor)}>
                        {record.status}
                      </span>
                    </div>
                  </div>
              ...
              <div className="p-5 space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-right">
                    ...
                    <span className={cn("text-xs font-medium px-2 py-1 rounded-md border mt-1 inline-block", selectedRecord.statusColor)}>
